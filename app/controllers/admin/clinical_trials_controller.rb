module Admin
class ClinicalTrialsController < AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @clinical_trial.save
        format.html { redirect_to edit_admin_clinical_trial_path(@clinical_trial), notice: 'Clinical trial was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @clinical_trial.update(clinical_trial_params)
        format.html { redirect_to edit_admin_clinical_trial_path(@clinical_trial), notice: 'Clinical trial was successfully updated.' }
  ...
  private
    ...
    def clinical_trial_params
      params.require(:clinical_trial).permit(:title, :image, :pdf)
    end
end
end
